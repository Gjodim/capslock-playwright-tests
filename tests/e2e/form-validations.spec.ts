...
test.describe("Verify fields validation", async () => {
  test("ZIP code validation", async ({ landingPage }) => {
  ...
  test("Service available email validation", async ({ landingPage }) => {
  ...
  test.fixme("Out of service email validation", async ({ landingPage }) => {
  ...
  test("Phone number validation", async ({ landingPage, page }) => {
